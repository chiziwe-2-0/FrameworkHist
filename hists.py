...
cpython64_rest = [1300.0, 3394.0, 3624.0, 1440.0, 3747.0]
pypy64_rest = [2238.0, 4409.0, 4227.0, 1323.0, 4715.0]

cpython512_get = [1749.0, 4191.0, 4461.0, 1554.0, 5605.0]
pypy512_get = [3023.0, 4314.0, 5189.0, 1774.0, 5655.0]

cpython512_rest = [1369.0, 3649.0, 3621.0, 1412.0, 5032.0]
pypy512_rest = [2010.0, 3653.0, 4225.0, 1343.0, 5214.0]

data = {'CPython 3.9': cpython512_rest,
        'PyPy 7.3.4': pypy512_rest}

df = pd.DataFrame(data)
df.plot(kind='bar')

name = 'REST-запросы (512)'
